...
$destinataire = 'mikeyouf@gmail.com';
...
$message_erreur_formulaire = "Vous devez d'abord <a href=\"/#fh5co-contact\">envoyer le formulaire</a>.";
...
//    $email = (IsEmail($email)) ? $email : ''; // soit l'email est vide si erroné, soit il vaut l'email entré
    ...
    else
    {
        ...
        echo '<p>'.$message_formulaire_invalide.' <a href="/#fh5co-contact">Retour au formulaire</a></p>'."\n";
    };
